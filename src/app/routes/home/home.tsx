            ...
            <div className="max-w-3xl">
              ...
              <div className="mt-8 grid grid-cols-4 gap-4 max-w-lg">
                {[
                  ...
                  { value: countdown.hours, label: t('hero.hrs') },
                  { value: countdown.minutes, label: t('hero.mins') },
                  { value: countdown.seconds, label: t('hero.secs') },
                ].map((item, idx) => (
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/30 p-6 backdrop-blur">
            ...
            {driverLoading ? (
              ...
              <div className="text-center text-sm py-8 text-slate-500">{t('home.no_drivers')}</div>
            )}
          </div>
